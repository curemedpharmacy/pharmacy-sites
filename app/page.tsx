          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            {services.length > 3 && (
              <div className="mt-12 text-center">
                <Link href="/services">
                  <Button className="group inline-flex items-center gap-2 bg-[#1A4A7A] hover:bg-[#0A1628] text-white px-8 py-3.5 rounded-full font-mono text-sm font-semibold uppercase tracking-wider transition-all duration-300 hover:scale-105 cursor-pointer shadow-lg shadow-[#1A4A7A]/20 hover:shadow-[#0A1628]/30">
                    View All Services
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="mt-8 flex flex-wrap items-center gap-4">
                  ...
                  <Link href="/locations">
                    <Button className="group inline-flex items-center gap-2 bg-transparent border-2 border-white/20 hover:border-[#4A9FFF] text-white hover:text-[#4A9FFF] px-8 py-3.5 rounded-full cursor-pointer font-mono text-sm font-semibold uppercase tracking-wider transition-all duration-300 hover:bg-white/5 hover:scale-105 hover:-translate-y-1">
                      Get Directions
                      <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
                    </Button>
                  </Link>
